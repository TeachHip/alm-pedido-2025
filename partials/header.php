	...
	<a href="./" style="text-decoration: none; color: #fff; display:block">
        <div class="container">
            <h1 style="text-decoration: none; color: #fff;">AlMercáu<small style="font-size: 0.35em; font-weight: normal;">v<?php echo htmlspecialchars(APP_VERSION_PUBLIC . ' ' . APP_VERSION_ALIAS); ?></small></h1>
